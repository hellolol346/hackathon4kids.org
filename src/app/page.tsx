      ...
      <div className="flex md:flex-row flex-col-reverse justify-between items-center">
        <div className="mb-10">
          ...
          <p className="p-3 rounded-md bg-blue-50">
            ...
            Registration for our Winter 2024 contest is open. View our flyer <Link target="_blank" href="/H4K_Coding_Competition_Flyer.png" className="underline">here</Link>!
          </p>
        </div>
        <Image
          src={girlWorkplace}
